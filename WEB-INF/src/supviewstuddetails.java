...
@WebServlet("/supviewstuddetails")
public class supviewstuddetails extends HttpServlet{
    public boolean fetch(int stud_id, int placement_id, HttpServletRequest request, HttpServletResponse response){
       ...
       try {
         ...
         if(result.next()){
             ...
             request.getRequestDispatcher("Supervisor/supviewstuddetails.jsp").forward(request, response);
