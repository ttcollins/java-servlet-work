...
public class notvisitedstuds extends HttpServlet{
    public boolean fetch(int sup_id, HttpServletRequest request, HttpServletResponse response){
        ...
        String dbPassword = "";
        int confirm = 0;
        String query = "select * from student where visited='"+confirm+"' and supervisor_id='"+sup_id+"'";
        try {
            ...
            request.getRequestDispatcher("Supervisor/notvisitedstuds.jsp").forward(request, response);
        }
