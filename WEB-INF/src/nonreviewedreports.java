...
public class nonreviewedreports extends HttpServlet{
    public boolean fetch(int sup_id, HttpServletRequest request, HttpServletResponse response){
        ...
        String dbPassword = "";
        String query = "select * from reports where supervisor_id='" + sup_id + "' and supervisor_comment is null";
        try {
            ...
            request.getRequestDispatcher("Supervisor/nonreviewedreports.jsp").forward(request, response);
        }
