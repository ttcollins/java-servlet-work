...
@WebServlet("/viewstudreports")
public class viewstudreports extends HttpServlet{
  ...
  try {
    ...
    request.getRequestDispatcher("HOD/viewstudreports.jsp").forward(request, response);
  }
...
throws ServletException, IOException{
    ...
    if(!fetch(user_id, fname, request, response)){
        ...
        request.getRequestDispatcher("viewstuddetails").forward(request, response);
    }
}
