...
@WebServlet("/supviewstudplacement")
public class supviewstudplacement extends HttpServlet{
    public boolean fetch(int placement_id, HttpServletRequest request, HttpServletResponse response){
       ...
       try {
         ...
         if(result.next()){
             ...
             request.getRequestDispatcher("Supervisor/supviewstudplacement.jsp").forward(request, response);
