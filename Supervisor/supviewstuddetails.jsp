            ...
            <div class="card">
                <div class="card-header"><strong><h3>STUDENT DETAILS.</h3></strong></div>
                    <div class="card-body card-block">
                        ...
                        <a href="supviewstudplacement?placement=<%=placement_id%>"><button class="btn btn-primary">Placement Letter</button></a><!-- button here -->
                        <a href='supviewstudreports?user=<%=request.getAttribute("user_id")%>&fname=<%=request.getAttribute("fname")%>'><button class="btn btn-primary">Reports</button></a><!-- button here -->
                    </div>
                </div>
            </div>
        </div>          
