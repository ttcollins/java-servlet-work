      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Confirmed Visits</h1>
          </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    ...
                    <td><b>Confirmed by Supervisor</b></td>
                  </tr>
                  <%Iterator itr;%>
                  ...
                  <tr>
                      ...
                      <td><%=itr.next()%></td>
                      <td>
                        <form method="GET" action="unconfirm">
                          <input type="hidden" name="ID" value="<%=itr.next()%>">
                          <button type="submit" class="btn btn-primary">Unconfirm</button>
                        </form>
                      </td>
                  </tr>
                      <%}%>
