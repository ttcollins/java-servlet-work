	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<div><h6 style="color:red"><%= (request.getAttribute("error") == null) ? "" : request.getAttribute("error") %></h6></div>
				<div><h6 style="color:green"><%= (request.getAttribute("go") == null) ? "" : request.getAttribute("go") %></h6></div>
				<div align="right"><i><a href="/NAD/register.jsp"><h6>Register</h6></a></i></div>
