      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Not Visited Students</h1>
          </div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><%=itr.next()%></td>
                      <td><%=itr.next()%></td>
                      <td><a href="viewvisitdetails?ID=<%=itr.next()%>"><button class="btn btn-primary">Visit Details</button></a></td><!-- button here -->
                  </tr>
                      <%}%>
                </tbody>
              </table>
